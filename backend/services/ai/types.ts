...
export type NormalizedBody = {
  ...
  backupSource: string;
  backupEnergySource: string;
  primaryEnergySource: string;
  backupPowerW: number | null;
  batteryBankAh: number | null;
  autonomyDays: number | null;
  iceAdaptation: string;
  frostProtection: string;
  bypass: string;
  annualSolarProductionKWh: number | null;
  annualLoadDemandKWh: number | null;
  annualEnergyBalanceKWh: number | null;
  ...
  discouragedMethods: string[];
  missingForFinalChoice: string[];
  documentationRequirements: string[];
  silentNveRequirements: string[];
  releaseRequirementVariation: string;
  releaseMethodSelected: string;
  releaseMethodLabel: string;
  minFlowClass: string;
  fishMigration: string;
  coandaExists: string;
  siteChallenges: string[];
  powerCommunication: string[];
  publicDisplay: string[];
  hourlyAutomaticLogging: string;
  secureDataStorageForNve: string;
  accuracyWithinFivePercent: string;
  completenessNinetySevenPercent: string;
  isSedimentClogging: string;
  fishPassage: string;
  bypassOnOutage: string;
