...
export const universalNveObligations: UniversalNveObligation[] = [
  ...
  obligation({
    ...
    title: "Nøyaktighet innen +/-5 prosent ved kravsatt slipp",
    sourceRefs: ["NVE_2024_MVF_4_1"],
    ...
    obligationText: "Valgt metode forutsetter nøyaktighet innen +/-5 prosent ved kravsatt slipp.",
    appliesTo: "all_methods",
    visibleToUserAsQuestion: false,
    mayAppearInReport: true,
    mayAppearInAiNarrative: true,
  ...
  obligation({
    ...
    obligationText: "Valgt metode forutsetter at dokumentasjon og måledata lagres og kan legges fram for NVE.",
    appliesTo: "all_methods",
    visibleToUserAsQuestion: false,
    mayAppearInReport: true,
    mayAppearInAiNarrative: true,
